...
$connect = new PDO("mysql:host=localhost;dbname=cafe", "ashish", "ash");
		...
		if($_POST["user_password"] != '') {
			if(password_verify($_POST["user_password"], $_SESSION["user_password"])) {
				...
				if($statement->execute($data))
				{
					...
					$mail->Port = '587';
					$mail->SMTPAuth = true;
					$mail->Username = 'autocreaters2019@gmail.com';
					$mail->Password = 'jecrcfoundation';
					$mail->SMTPSecure = 'tls';
					$mail->From = 'autocreaters2019@gmail.com';
					$mail->FromName = 'Ashish Maheshwari';
					$mail->AddAddress($_SESSION["user_email"]);
					$mail->WordWrap = 50;
					$mail->IsHTML(true);
					$mail->Subject = 'Verification code for Login';
					$message_body = '
					<p>For verify your login details, enter this verification code when prompted: <b>'.$login_otp.'</b>.</p><p>Sincerely,</p><b>Ashish Maheshwari</b>Technical Head';
